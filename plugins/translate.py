...
async def translate_text(bot,update):
	...
	[InlineKeyboardButton(" Növbəti --->",callback_data = "page2")
      ...
      keybord2= InlineKeyboardMarkup([
           ...
           [InlineKeyboardButton("<--- Əvvəlki",callback_data = "page1"),
      ...
      keybord3 = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("<--- Əvvəlki",callback_data = "page2"),
      ...
      keybord4 = InlineKeyboardMarkup([
          ...
          [InlineKeyboardButton("<--- Əvvəlki",callback_data = "page3"),
      ...
      keybord5 = InlineKeyboardMarkup([
         ...
         [InlineKeyboardButton("<--- Əvvəlki",callback_data = "page4"),
      ...
      keybord6 =  InlineKeyboardMarkup([
       ...
       [InlineKeyboardButton("<--- Əvvəlki",callback_data = "page5")
